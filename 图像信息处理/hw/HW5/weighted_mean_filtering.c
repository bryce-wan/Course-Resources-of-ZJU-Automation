...
int main()
{
    ...
    char *obj_filename = "img\\weighted_mean_filtering.bmp";

    readBMP(filename, &Img, &Cache);

    double weighted_mean_filter[9] = {1. / 16, 2. / 16, 1. / 16, 2. / 16, 4. / 16, 2. / 16, 1. / 16, 2. / 16, 1. / 16};

    Convolve(&Img, &Cache, weighted_mean_filter);
