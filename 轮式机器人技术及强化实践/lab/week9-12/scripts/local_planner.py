...
# from dwa import DWAPlanner, Config
import dwa1
...
class LocalPlanner:
    ...
    def laserCallback(self, msg):
        ...
        for i in range(len(msg.ranges)):
            ...
            if r < self.threshold:
                ...
                # print([math.cos(a) * r, math.sin(a) * r])
    ...
    def planOnce(self):
        ...
        # Update obstacle
        self.updateObstacle()
        u = dwa1.plan(self.plan_x, self.config, self.plan_goal, self.plan_ob)
        alpha = 0.5
        # print(u[0],u[1])
